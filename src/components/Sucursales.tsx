...
// Approximate coordinates for Mendoza locations
const coords: Record<number, [number, number]> = {
  1: [-68.5017, -32.9282], // Guaymallén
  2: [-68.5000, -32.9270],
  3: [-68.5750, -32.9830], // Chacras de Coria
  4: [-68.5780, -32.9800],
  5: [-68.5050, -32.9250],
  6: [-68.5650, -32.9700], // Luján de Cuyo
}
...
export default function Sucursales() {
  ...
  return (
    <section id="sucursales" className="bg-dark-soft py-16 sm:py-24">
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              ...
              <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-campo">Encontranos</span>
            </motion.div>
            <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              Nuestras <span className="text-gradient-green">Sucursales</span>
            </motion.h2>
          </div>
          <p className="max-w-xs text-xs leading-relaxed text-warm">
            6 puntos de venta en Mendoza. Carne fresca todos los días. Hacé click en un marcador para ver detalles.
          </p>
        </div>
              ...
              return (
                <Popup longitude={lng} latitude={lat} anchor="bottom" offset={35}
                  ...
                  <div className="p-4 min-w-[200px]">
                    ...
                    <p className="text-xs text-warm">{suc.telefono} · {suc.horario}</p>
